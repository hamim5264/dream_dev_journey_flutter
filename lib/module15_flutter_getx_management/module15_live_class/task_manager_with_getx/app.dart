...
import 'package:dream_dev_journey_flutter/module15_flutter_getx_management/module15_live_class/task_manager_with_getx/data/utilities/theme_utility.dart';
...
import 'package:dream_dev_journey_flutter/module15_flutter_getx_management/module15_live_class/task_manager_with_getx/ui/state_managers/controller_binding.dart';
...
class TaskManagerAppWithGetX extends StatefulWidget {
  static GlobalKey<NavigatorState> globalKey = GlobalKey<NavigatorState>();

  const TaskManagerAppWithGetX({super.key});

  @override
  State<TaskManagerAppWithGetX> createState() => _TaskManagerAppWithGetXState();
}

class _TaskManagerAppWithGetXState extends State<TaskManagerAppWithGetX> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    return GetMaterialApp(
      navigatorKey: TaskManagerAppWithGetX.globalKey,
      title: 'Task Manager',
